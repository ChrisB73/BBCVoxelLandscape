...
; With zx02 compressor
; Nula Version

codestart=&800     ; Code load address
maxpos=&17        ; page of landscape data
datapos=&B8       ; Overwrite end of BASIC + user code - Not OK....
loadpos1=&40
loadpos2=&57

palette=(maxpos*256)+16*1024
...
equs      "====================",13,10
equs "Mode 2 Tube NuLA Version",13,10,13,10
...
.lastblock
    ...
    lda colour          ; Get colour to plot
.bottombranch
    bcc dlbottomblock     ; Always taken
.dlbottomblock
    sta (plotposition),Y:iny
    sta (plotposition),Y:iny
    sta (plotposition),Y:iny
...
putfile "maps\map128x128_25.bin.zx02","M.A",&B800
putfile "maps\C28W-fs8_c.bin.zx02","C.A",&1600
putfile "maps\C25W-fs8_c.bin.zx02","C.I",&1600

putfile "maps\map128x128_15.bin.zx02","M.B",&B800
putfile "maps\C15-fs8_c.bin.zx02","C.B",&1600
putfile "maps\C27W-fs8_c.bin.zx02","C.J",&1600

putfile "maps\map128x128_21.bin.zx02","M.C",&B800
putfile "maps\C23W-fs8_c.bin.zx02","C.C",&1600
putfile "maps\C21-fs8_c.bin.zx02","C.K",&1600

putfile "maps\map128x128_16.bin.zx02","M.D",&B800
putfile "maps\C16W-fs8_c.bin.zx02","C.D",&1600
putfile "maps\C29W-fs8_c.bin.zx02","C.L",&1600

putfile "maps\map128x128_9.bin.zx02","M.E",&B800
putfile "maps\C9W-fs8_c.bin.zx02","C.E",&1600

putfile "maps\map128x128_11.bin.zx02","M.F",&B800
putfile "maps\C11W-fs8_c.bin.zx02","C.F",&1600

putfile "maps\map128x128_10.bin.zx02","M.G",&B800
putfile "maps\C10W-fs8_c.bin.zx02","C.G",&1600

putfile "maps\map128x128_22.bin.zx02","M.H",&B800
putfile "maps\C22W-fs8_c.bin.zx02","C.H",&1600
